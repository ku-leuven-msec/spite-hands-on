...
:- use_module('./reasoning/modules/access_control.pl').
%:- consult('./core/modules/access_control.pl').
%:- use_module('./core/modules/asset_device_conversion.pl').
:- use_module('./reasoning/modules/asset_device_conversion.pl').

:- use_module('./reasoning/modules/app.pl').
:- use_module('./reasoning/modules/data_preprocessing.pl').
:- use_module('./reasoning/modules/bus.pl').
:- use_module('./reasoning/modules/query.pl').
:- use_module('./reasoning/modules/device.pl').
:- use_module('./reasoning/utilities.pl').
:- use_module('./reasoning/engine-structure.pl').

%:- consult('./core/modules/app.pl').
%:- consult('./core/modules/data_preprocessing.pl').
%:- consult('./core/modules/bus.pl').
%:- consult('./core/modules/query.pl').
%:- consult('./core/modules/device.pl').
%:- consult('./core/utilities.pl').
%:- consult('./core/engine-structure.pl').
...
get_modules(ModuleNames) :-
    directory_files('./reasoning/modules', Modules),
